...
% Code highlighting
%\definecolor{dark-gray}{gray}{0.15}% THIS LIGHT GRAY DOES NOT SHOW ON MOST PRINT
...
\newcommand{\pr}[1]{\texttt{\textcolor{OliveGreen}{#1}}} % primitives
\newcommand{\high}[1]{ \underline{#1} } % highlight currently executed subexpression


\begin{document}

\title{Programming with Computational Fields in Scala}

\author{\IEEEauthorblockN{Roberto Casadei\IEEEauthorrefmark{1},
Mirko Viroli\IEEEauthorrefmark{1}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}DISI Department,
...
\begin{IEEEkeywords}
	aggregate programming; computational fields; domain-specific languages
\end{IEEEkeywords}
